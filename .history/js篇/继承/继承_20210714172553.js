...
// es6 继承
// 在子类的constructor，如果要用到this，就要先执行super()方法
class Parent {
  constructor(name) {
    this.name = name
  }
...
// 然后再将父类的方法添加到this上（Parent.call(this)）.


// ES6的继承有所不同，实质上是先创建父类的实例对象this
// 然后再用子类的构造函数修改this。因为子类没有自己的this对象，
// 所以必须先调用父类的super()方法，否则新建实例报错。
